...
if($proses=='excel')
{
    ...
    $tab.="<table border=0>
         <tr>
            <td colspan=8 align=left><font size=3>ANALISA BIAYA PEMELIHARAAN TM</font></td>
...
//}
    ...
    $tab.= "<td rowspan=2 colspan=2 ".$bgcoloraja.">Anggaran Tahunan</td></tr>";
    $tab.="<tr>";
    ...
    $tab.="<td align=left ".$bgcoloraja.">LUAS - HA</td>";
    ...
    $tab.="<td align=left ".$bgcoloraja.">HASIL PRODUKSI (TON)</td>";
    ...
    $tab.="<tr>";
    $tab.="<td  ".$bgcoloraja.">&nbsp;</td>";
    $tab.= "<td align=right ".$bgcoloraja.">&nbsp;</td>";
    ...
    $tab.= "<td align=right ".$bgcoloraja.">Rp./Ha</td>";
    $tab.= "<td align=right ".$bgcoloraja.">&nbsp;</td>";
    $tab.= "<td align=right ".$bgcoloraja.">&nbsp;</td><td align=right> ".$bgcoloraja."Rp./Ha</td></tr>";
